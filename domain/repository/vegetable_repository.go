...
type VegetableRepository interface {
	FindMyVegetables(ctx context.Context, userAccessToken string) ([]*protocol.Vegetable, error)
	...
	DeleteMyVegetable(ctx context.Context, userAccessToken string, vegetableID int64) error
}
