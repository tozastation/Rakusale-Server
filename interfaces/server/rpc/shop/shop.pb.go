...
package shop // import "github.com/2018-miraikeitai-org/Rakusale-Another-Server/interfaces/server/rpc/shop"
...
func (*RequestShop) Descriptor() ([]byte, []int) {
	return fileDescriptor_shop_58199a24b4821f9c, []int{0}
}
...
func (dst *RequestShop) XXX_Merge(src proto.Message) {
	xxx_messageInfo_RequestShop.Merge(dst, src)
}
...
func (*ResponseShop) Descriptor() ([]byte, []int) {
	return fileDescriptor_shop_58199a24b4821f9c, []int{1}
}
...
func (dst *ResponseShop) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ResponseShop.Merge(dst, src)
}
...
func (*GetMyShopRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_shop_58199a24b4821f9c, []int{2}
}
...
func (dst *GetMyShopRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_GetMyShopRequest.Merge(dst, src)
}
...
func (*GetMyShopResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_shop_58199a24b4821f9c, []int{3}
}
...
func (dst *GetMyShopResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_GetMyShopResponse.Merge(dst, src)
}
...
func (*ShopsEmpty) Descriptor() ([]byte, []int) {
	return fileDescriptor_shop_58199a24b4821f9c, []int{4}
}
...
func (dst *ShopsEmpty) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ShopsEmpty.Merge(dst, src)
}
...
func (*GetAllShopsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_shop_58199a24b4821f9c, []int{5}
}
...
func (dst *GetAllShopsResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_GetAllShopsResponse.Merge(dst, src)
}
...
func (*ShopImage) Descriptor() ([]byte, []int) {
	return fileDescriptor_shop_58199a24b4821f9c, []int{6}
}
...
func (dst *ShopImage) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ShopImage.Merge(dst, src)
}
...
func (*PostMyShopRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_shop_58199a24b4821f9c, []int{7}
}
...
func (dst *PostMyShopRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_PostMyShopRequest.Merge(dst, src)
}
...
func (*PostMyShopResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_shop_58199a24b4821f9c, []int{8}
}
...
func (dst *PostMyShopResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_PostMyShopResponse.Merge(dst, src)
}
...
func (*PutMyShopRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_shop_58199a24b4821f9c, []int{9}
}
...
func (dst *PutMyShopRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_PutMyShopRequest.Merge(dst, src)
}
...
func (*PutMyShopResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_shop_58199a24b4821f9c, []int{10}
}
...
func (dst *PutMyShopResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_PutMyShopResponse.Merge(dst, src)
}
...
func (*DeleteMyShopRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_shop_58199a24b4821f9c, []int{11}
}
...
func (dst *DeleteMyShopRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_DeleteMyShopRequest.Merge(dst, src)
}
...
func (*DeleteMyShopResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_shop_58199a24b4821f9c, []int{12}
}
...
func (dst *DeleteMyShopResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_DeleteMyShopResponse.Merge(dst, src)
}
...
func init() { proto.RegisterFile("shop.proto", fileDescriptor_shop_58199a24b4821f9c) }

var fileDescriptor_shop_58199a24b4821f9c = []byte{
